...
function Login(_ref) {
  var routeAfterLogin = _ref.routeAfterLogin;
  ...
  console.log(_firebaseSetup.auth.currentUser, 'user details');
  var handleSubmit = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var email, password, userData, user, token, userDetails;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return (0, _auth.signInWithEmailAndPassword)(_firebaseSetup.auth, email, password);
          case 6:
          ...
          case 10:
            ...
            setIsLoading(false);
            userDetails = {
              displayName: _firebaseSetup.auth.currentUser.displayName,
              email: _firebaseSetup.auth.currentUser.email,
              phoneNumber: _firebaseSetup.auth.currentUser.phoneNumber
            };
          ...
          case 18:
            ...
            setIsLoading(false);
            (0, _ErrorHandling.firebaseErrorHandling)(_context.t0.code);
          case 23:
          case "end":
  ...
  var handleGoogleSignin = function handleGoogleSignin() {
    ...
    (0, _auth.signInWithPopup)(_firebaseSetup.auth, provider).then( /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(result) {
        var credential, user, token, userDetails;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              console.log(result, 'result');
              // This gives you a Google Access Token. You can use it to access the Google API.
              credential = _auth.GoogleAuthProvider.credentialFromResult(result);
              user = result.user;
              _context2.next = 5;
              return user.getIdToken();
            case 5:
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "button",
    type: "submit"
  }, loading ? /*#__PURE__*/_react.default.createElement(_lucideReact.Loader, null) : /*#__PURE__*/_react.default.createElement("h4", {
  ...
  }, /*#__PURE__*/_react.default.createElement("span", null, "New to Norebase? "), /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
    to: "/signup",
