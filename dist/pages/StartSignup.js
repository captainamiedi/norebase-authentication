...
var StartSignup = function StartSignup(_ref) {
  var routeAfterSignup = _ref.routeAfterSignup;
  ...
  var _useState7 = (0, _react.useState)(null),
    ...
    firebaseUser = _useState8[0],
    setFirebaseUser = _useState8[1];
  var navigate = (0, _reactRouterDom.useNavigate)();
  var handleChange = function handleChange(_ref2) {
    var _ref2$target = _ref2.target,
      name = _ref2$target.name,
      value = _ref2$target.value;
    setSignupData(_objectSpread(_objectSpread({}, signupData), {}, _defineProperty({}, name, value)));
  };
  var provider = new _auth.GoogleAuthProvider();
  var handleFirstSubmit = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var email, password, userData, user, token;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return (0, _auth.createUserWithEmailAndPassword)(_firebaseSetup.auth, email, password);
          case 8:
          ...
          case 19:
            ...
            console.log(_context.t0, 'sign up error');
            setIsLoading(false);
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 7;
            return (0, _auth.updateProfile)(firebaseUser, {
          ...
          case 11:
            ...
            console.log(_context2.t0, 'update profile error');
            setIsLoading(false);
          case 15:
          case "end":
    ...
    switch (componentStep) {
      ...
      case 2:
        return /*#__PURE__*/_react.default.createElement(_Welcome.default, {
          setStep: setStep,
          handleChange: handleChange,
          handleFirstSubmit: handleSubmit,
          loading: loading
        });
      // case 3:
